...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-base-bernoulli/tags). For example,

```javascript
bernoulli = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-bernoulli@v0.2.2-umd/browser.js' )
```
